...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_same_integers(self):
        """ same integers in list
        """
        test_list1 = [8, 8, 8, 8, 8]
        test_list2 = [-5, -5, -5, -5]
        self.assertEqual(max_integer(test_list1), 8)
        self.assertEqual(max_integer(test_list2), -5)
    ...
    def test_characters_list(self):
        ...
        """
        test_list = ['b', 'e', 'y', 'm']
        self.assertEqual(max_integer(test_list), 'e')

    def test_numbers_character(self):
        """list of numbers and character/s
        """
        test_list1 = [1, 2, 3, 'x']
        test_list2 = [-1, -2, -3, 'x']
        test_list3 = [1.1, 2.2, 3.3, 'x']
        test_list4 = [-1.1, 2.2, -3.3, 'x']
        with self.assertRaises(TypeError):
    ...
    def test_mixed_characters(self):
        """mixture of characters in list including +ve and -ve
        """
        test_list1 = ['-a', '-d', '-k', '-f']
        test_list2 = ['-a', '-d', 'q', '-w']
        test_list3 = ['-a', 'c', 'k', '-w']
        self.assertEqual(max_integer(test_list1), '-f')
        self.assertEqual(max_integer(test_list2), 'q')
        self.assertEqual(max_integer(test_list3), 'c')

    def test_mixed_list(self):
        """ list containing various types
        """
        test_list1 = [5, 3, "57", "born" -7, [90], {56}, '-z', 'c']
        with self.assertRaises(TypeError):
            max_integer(test_list1)
    ...
    def test_float_numbers(self):
        ...
        """
        test_list1 = [8.7, 2.3, 6.8, 0.1]
        test_list2 = [7, 2, 6.8, 0.1]
        test_list3 = [-9.1, -2.3, 6.5, 0.1]
        test_list4 = [-9, -2, -6.8, -5.1]
        test_list5 = [-9, -2, -6.8, 5.1]
        self.assertEqual(max_integer(test_list1), 8.7)
        self.assertEqual(max_integer(test_list2), 7)
        self.assertEqual(max_integer(test_list3), 6.5)
        self.assertEqual(max_integer(test_list4), -5.1)
        self.assertEqual(max_integer(test_list5), 5.1)
